...
del .\*.cpp
::安装基本类
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/加密器.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/MD转换器.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/标准流.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/程序.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/时间.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/数学.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/数组.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/随机数.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/文件.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/线程.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/字符串.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/错误处理.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/引脚.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/通用引脚.losu
wget --no-check-certificate https://gitee.com/chen-chaochen/lpk/raw/release/losu1.2.6/windows/inc/网页.losu
